...
#' don't know
#'
#' @param d numeric first argument
#' @param matched.normal numeric first argument
#' @return don't know
...
#'
#' @param orig numeric first argument
...
#' @param sampID numeric first argument
#' @return don't know
...
#' don't know
#'
#' @param x numeric first argument
#' @param pch numeric first argument
#' @param cex numeric first argument
#' @param label numeric first argument
#' @return don't know
