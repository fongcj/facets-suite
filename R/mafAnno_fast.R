...
#' don't know
#'
#' @param filenames numeric first argument
#' @param fn numeric first argument
#' @return don't know
fread_rbind <- function(filenames, fn = fread){
  rbindlist(idcol = "filename",
            sapply(USE.NAMES = TRUE,
                   simplify = FALSE,
                   filenames,
                   fn))
}
...
#' @name estimated_af_life_history
#' @title don't know
#' @description
#'
#' don't know
...
#' @param ns numeric first argument
#' @param nw numeric first argument
#' @param m numeric first argument
#' @param M numeric first argument
#' @param copies numeric first argument
#' @param limit boolean first argument
#' @return don't know
...
#' @param em numeric first argument
#' @return don't know
...
#' @name annotate_maf_with_facets_cf_tcn_lcn
#' @title don't know
#' @description
#'
#' temporary function
...
#' @param out numeric first argument
#' @param fit numeric first argument
#' @param iTumor_Sample_Barcode numeric first argument
#' @return don't know
...
#' @name annotate_maf_with_facets_cf_tcn_lcn_cncf
#' @title don't know
#' @description
#'
#' temporary function
#'
#' @param maf numeric first argument
#' @param cncf numeric first argument
#' @return don't know
...
#'
#' @param purity numeric first argument
#' @param absCN numeric first argument
#' @param alt_allele numeric first argument
#' @param coverage numeric first argument
#' @param copies numeric first argument
#' @return don't know
...
#' @name ccf.likelihood.purity.fit
#' @title don't know
#' @description
#'
#' temporary function
...
#' @param purity_fit_filename numeric first argument
#' @return don't know
