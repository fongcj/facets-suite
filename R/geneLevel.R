...
#' @name convert_gene_level_calls_to_matrix_portal
#' @title don't know
#' @description
#'
#' don't know
...
#' @param gene_targets numeric first argument
#' @param WGD_threshold numeric first argument
#' @param amp_threshold numeric first argument
#' @param max_seg_length numeric first argument
#' @param min_cf numeric first argument
...
#' don't know
#'
#' @param gene_level_calls numeric first argument
#' @return don't know
