...
#' @return don't know
plot_vaf_by_cn_state = function(maf, sample, purity, wgd=FALSE){
  maf.tmp <- maf[lcn == mcn]
...
#'
#' @param maf numeric first argument
#' @param facets numeric first argument
#' @param plot numeric first argument
#' @return don't know
main = function(maf, facets, plot=FALSE){
