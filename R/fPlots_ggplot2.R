...
#' @name var.allele.log.odds.ratio 
#' @title don't know
#' @description
#'
#' temporary function
...
#' @name get.cumulative.chr.maploc 
#' @title don't know
#' @description
#'
#' temporary function
#'
#' @param mat numeric first argument
#' @param load.genome boolean first argument
#' @return don't know
...
#' temporary function
#'
#' @param hugo.symbol numeric first argument
#' @param my.path numeric first argument
#' @param load.genome numeric first argument
#' @return don't know
...
#' @param out numeric first argument
#' @param fit numeric first argument
#' @param w numeric first argument
#' @param h numeric first argument
#' @param type numeric first argument
#' @param load.genome numeric first argument
#' @param main numeric first argument
#' @param plotname numeric first argument
#' @param gene.name numeric first argument
#' @param lend numeric first argument
#' @param em.plot numeric first argument
#' @param subset.snps numeric first argument
#' @return don't know
plot.facets.all.output = function(out, fit, w=850, h=1100, type='png', load.genome=FALSE, main='', plotname='test', gene.name=NULL, lend='butt', em.plot = FALSE, subset.snps=FALSE){
...
#' @param by_factor numeric first argument
#' @return don't know
...
#' @param out numeric first argument
#' @param fit numeric first argument
#' @param chrom.range numeric first argument
#' @param method numeric first argument
#' @param gene.name numeric first argument
#' @param lend numeric first argument
#' @param bed.path numeric first argument
#' @param subset.snps numeric first argument
#' @param theme numeric first argument
#' @param plotX numeric first argument
#' @return don't know
close.up = function(out, fit, chrom.range=NULL, method=NA, gene.name=NULL, lend='butt', bed.path=NULL, subset.snps=FALSE, plotX = FALSE, ...){
  ...
  if (!is.null(bed.path)){ 
    gene.info = get.gene.pos(gene.name, my.path = bed.path)
  } else { 
    gene.info = get.gene.pos(gene.name) 
  }
